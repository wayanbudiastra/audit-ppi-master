            ...
            <div class="py-4 text-gray-500 dark:text-gray-400">
                ...
                <ul class="mt-6">
                    <li class="relative px-6 py-3">
                        <span class="absolute inset-y-0 left-0 w-1 bg-green-500 rounded-tr-lg rounded-br-lg"
                ...
                <ul>
                    <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
                            ...
                            <span class="ml-4">Hand Hygiene</span>
                        </a>
                    </li>
                    {{-- <li class="relative px-6 py-3">
                        <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
            ...
            <header class="z-10 py-4 bg-white shadow-md dark:bg-gray-800">
                <div
                    ...
                    <ul class="flex items-center flex-shrink-0 space-x-6">
                        ...
                        <li class="relative">
                            <button
                                ...
                                <svg version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    viewBox="0 0 489.802 489.802" style="enable-background:new 0 0 489.802 489.802;"
                                    xml:space="preserve" class="w-5 h-5" aria-hidden="true" fill="currentColor"
                                    viewBox="0 0 20 20">
                        ...
                        <li class="relative">
                            <button
                                class="align-middle rounded-full focus:shadow-outline-green focus:outline-none-green"
                                ...
                                {{-- <img class="object-cover w-8 h-8 rounded-full"
                                    src="{{ asset('images/person-check.svg') }}" alt="" aria-hidden="true" /> --}}
                            </button>
