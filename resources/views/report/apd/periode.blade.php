...
@section('content')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid mt-2">
            <!-- CTA -->
            <h1 class="mt-3 mb-3 flex justify-center text-lg font-semibold">Rekap APD Per-Periode</h1>
            <div class="w-full overflow-hidden rounded-lg shadow-xs mt-2">
                <div class="w-full overflow-x-auto">

                    <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">
                        <form action="{{ url('report-apd-perperiode-tahun') }}" method="POST">
                            {{ csrf_field() }}
                        ...
                        <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                            @foreach ($periode as $item)
                                ...
                                <tr>
                                    ...
                                    <td class="px-4 py-3 text-sm">
                                        {{ apd_kesempatan_rekap_periode($item->id) }}
                                    </td>
