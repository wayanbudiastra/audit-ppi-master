...
@section('content')
    <main class="h-full pb-16 overflow-y-auto">
        <div class="container px-6 mx-auto grid mt-2">
            <!-- CTA -->
            <form action="{{ route('handhygiene') }}" method="POST">
                {{ csrf_field() }}
                                ...
                                <div class="px-4 py-5 bg-white sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <input type="text" name="observer" id="observer" value="{{ old('observer') }}"
                                                class="mt-1 focus:ring-green-500 focus:border-green-500 block border-gray-300 w-full shadow-sm sm:text-sm  rounded-md @error('observer') border-red-500 @enderror" />
                                            @error('observer')
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <input type="date" name="tanggal_observasi" id="tanggal_observasi"
                                                ...
                                                class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md  @error('tanggal_observasi') border-red-500 @enderror" />
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            ...
                                            <input type="text" name="lantai" id="lantai" value="{{ old('lantai') }}"
                                                class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md  @error('lantai') border-red-500 @enderror" />
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            <select id="profesi_id" name="profesi_id" autoComplete="profesi_id"
                                                class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm  @error('periode') border-red-500 @enderror">
                                        ...
                                        <div class="col-span-6 sm:col-span-6 lg:col-span-3">
                                            ...
                                            <input type="text" name="waktu_start" id="waktu_start"
                                                value="{{ old('waktu_start') }}"
                                                class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md  @error('waktu_start') border-red-500 @enderror" />
                                            @error('waktu_start')
                                                <div class=" text-red-500 mt-2 rounded-sm relative text-sm" role="alert">
                                                    <span class="block sm:inline">{{ $message }}</span>
                                                </div>
                                        ...
                                        <div class="col-span-6 sm:col-span-3 lg:col-span-3">
                                            ...
                                            <input type="text" name="waktu_end" id="waktu_end"
                                                value="{{ old('waktu_end') }}" autoComplete="waktu_end"
                                                class="mt-1 focus:ring-green-500 focus:border-green-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md  @error('waktu_end') border-red-500 @enderror" />
                                            @error('waktu_end')
                                                <div class=" text-red-500 mt-2 rounded-sm relative text-sm" role="alert">
                                                    <span class="block sm:inline">{{ $message }}</span>
                                                </div>
